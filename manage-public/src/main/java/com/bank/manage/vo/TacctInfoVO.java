...
public class TacctInfoVO implements Serializable {

    private static final long serialVersionUID = -1543701357222498305L;
    ...
    @ApiModelProperty(value = "开户机构号名称")
