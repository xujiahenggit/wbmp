 ...
 */
@Data
@TableName("T_EXAMPLE_ADMIN")
@ApiModel(value = "ExampleAdmin对象", description = "全国标杆网点统计表(管理员) ")
public class ExampleAdminDO implements Serializable {

  private static final long serialVersionUID = -6920422768651031364L;
  /**
     * 主键
     */
