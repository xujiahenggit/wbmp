 ...
 */
@Data
@TableName("T_STAR_DATA_TEMP_BRANCH")
@ApiModel(value = "StarDataTempBranch对象", description = "行内星级标准化网点统计(全行) ")
public class StarDataTempBranchDO implements Serializable {


  private static final long serialVersionUID = 8084147002453847617L;
  /**
     * 主键
     */
