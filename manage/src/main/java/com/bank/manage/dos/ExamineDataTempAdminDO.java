 ...
 */
@Data
@TableName("T_EXAMINE_DATA_TEMP_ADMIN")
@ApiModel(value = "ExamineDataTempAdmin对象", description = " 考核原始数据-从表(管理员)")
public class ExamineDataTempAdminDO implements Serializable {

  private static final long serialVersionUID = -7835691393149210249L;
  /**
     * 主键
     */
