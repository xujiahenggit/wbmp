 ...
 */
@Data
@TableName("T_EXAMINE_DATA_ADMIN")
@ApiModel(value = "ExamineDataAdmin对象", description = "考核原始数据-主表(管理员) ")
public class ExamineDataAdminDO implements Serializable {

  private static final long serialVersionUID = -9044348609488983799L;
  /**
     * 主键
     */
