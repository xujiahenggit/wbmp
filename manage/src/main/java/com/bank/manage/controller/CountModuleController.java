...
public class CountModuleController extends BaseController {
	...
	public Boolean saveCountModule(@RequestBody @ApiParam(value = "countModuleVoList列表") List<CountModuleVo> countModuleVo
	...
	public Boolean updateCountModule(@RequestBody @ApiParam(value = "countModuleVoList列表") List<CountModuleVo> countModuleVo
			, HttpServletRequest request){
		TokenUserInfo tokenUserInfo=getCurrentUserInfo(request);
