...
public class ExamineDataBranchListener extends AnalysisEventListener<ExamineDataVo> {
    ...
    public ExamineDataBranchListener(Integer excelDataId,String excelDate,String excelQuarter,
                                     ExamineDataBranchService examineDataBranchService,ImportExcelResponse response){
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        ...
        saveBranchData(mapData);
    }

    public void saveBranchData(Map<String,Object> mapData){
        examineDataBranchService.saveBranchData(mapData);
    }
}
