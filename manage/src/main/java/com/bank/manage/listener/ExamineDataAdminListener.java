...
public class ExamineDataAdminListener extends AnalysisEventListener<ExamineDataVo> {
    ...
    public ExamineDataAdminListener(Integer excelDataId, String excelDate, String excelQuarter, ExamineDataAdminService examineDataAdminService, ImportExcelResponse response) {
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        ...
        saveAdminData(this.mapData);
    }

    public void saveAdminData(Map<String, Object> mapData) {
        this.examineDataAdminService.saveAdminData(mapData);
    }
}
