...
public class CatalogServiceImpl implements CatalogService {
    ...
    public Integer insertCatalog(CatalogDTO catalogDTO) {
        ...
        return this.catalogDao.insert(cataLogDO);
    }
    ...
    public Integer updateCatalog(CatalogDTO catalogDTO) {
        ...
        return this.catalogDao.updateById(cataLogDO);
    }

    @Override
    public Integer deleteCatalog(Integer id) {
        if (id.intValue() == 6) {
            throw new BizException("手机轮播图素材库目录不允许删除");
        }
        return this.catalogDao.deleteById(id);
    }
